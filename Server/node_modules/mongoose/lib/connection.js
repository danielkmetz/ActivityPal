 ...
 * #### Example:
 *
 *     mongoose.createConnection('***REMOVED***').name; // "mydb"
 *
 * @property name
 * @memberOf Connection
 * @instance
 ...
 * #### Example:
 *
 *     const db = mongoose.createConnection('***REMOVED***');
 ...
 * #### Example:
 *
 *     mongoose.createConnection('***REMOVED***').host; // "127.0.0.1"
 *
 * @property host
 * @memberOf Connection
 * @instance
 ...
 * #### Example:
 *
 *     mongoose.createConnection('***REMOVED***').port; // 27017
 *
 * @property port
 * @memberOf Connection
 * @instance
 ...
 * #### Example:
 *
 *     mongoose.createConnection('***REMOVED***').user; // "val"
 *
 * @property user
 * @memberOf Connection
 * @instance
 ...
 * #### Example:
 *
 *     mongoose.createConnection('***REMOVED***').pass; // "psw"
 *
 * @property pass
 * @memberOf Connection
 * @instance
 ...
 * #### Example:
 *
 *     const conn = mongoose.createConnection('***REMOVED***');
 ...
 * #### Example:
 *
 *     const conn = await mongoose.createConnection('***REMOVED***').
 *       asPromise();
 ...
 *     const conn = await mongoose.createConnection('***REMOVED***').asPromise();
 *
