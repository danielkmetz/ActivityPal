...
import { acceptInvite, rejectInvite } from '../../Slices/PostsSlice';
          ...
          <GestureDetector gesture={gesture}>
            <Animated.View style={[styles.modalContainer, animatedStyle]}>
              ...
              <ScrollView>
                ...
                {(invite?.sender?.userId || invite?.sender?.firstName) && (
                  <View style={styles.infoRow}>
                    <Text style={styles.label}>From:</Text>
                    <Image
                      source={
                        invite?.sender?.presignedProfileUrl
                          ? { uri: invite?.sender?.presignedProfileUrl }
                          : profilePicPlaceholder
                      }
                      style={styles.profilePic}
                    />
                ...
                <View style={styles.infoRow}>
                  ...
                  >
                    {invite?.business?.presignedPhotoUrl && (
                      <Image
                        source={{ uri: invite.business.presignedPhotoUrl }}
                ...
                {isSender && (
                  <View style={styles.actionsRow}>
                    ...
                    <TouchableOpacity
                      ...
                      onPress={() => {
                        onDelete?.(invite); // parent handles deleteInvite thunk
                        onClose?.();
                      }}
                    >
